<template>
  <v-container>
    <v-col align="center">
      <v-card>
        <v-card-title>
          <h2>Proyectos Prácticas Profesionales</h2>
          ...
          <v-spacer></v-spacer>
          <v-btn color="success" @click="registrarProyectoPractica()">
            Nuevo
          </v-btn>
        </v-card-title>
        <v-divider></v-divider>
        ...
        >
          <template v-slot:item.edicion="{ item }">
            <v-icon
              ...
              small
              class="mr-2"
              @click="modificarProyectoPractica(item)"
            >
              mdi-pencil
            </v-icon>
            <v-icon
...
<script src="./../../scripts/scripts-coordinador/ConsultaProyectoPractica.js"></script>
